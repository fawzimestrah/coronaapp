...
public class DI_Adapter_CheckboxAdmin extends ArrayAdapter<Data_GroupADMIN> {

    Context myContext;
    int resource;
    ArrayList<Data_GroupADMIN> myData = null;

    public DI_Adapter_CheckboxAdmin(@NonNull Context context, int resource, List<Data_GroupADMIN> myData) {
