...
public class Main_RegisterAdmin extends AppCompatActivity {
    ...
    //    ChGroup=(CheckBox)findViewById(R.id.IdCheckGroup);
        ...
        AddGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Main_RegisterAdmin.this, MainAddGroup.class);
...
*/
                            ...
                            newUserRef.set(user);
                            UserData userAdmin=new UserData(FirebaseAuth.getInstance().getUid(),email,TYPE_Account);
                            UserData.insert_User_Admin(userAdmin,ListGroupAdmin);//
                            redirectLoginScreen();
    ...
    private void redirectLoginScreen(){
        ...
        Intent intent = new Intent(Main_RegisterAdmin.this, MainAdmin.class);
