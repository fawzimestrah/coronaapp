...
public class Main_RegisterClient extends AppCompatActivity {
...
//type account
    private String TYPE_Account="C1";
    //vars
...
*/
                           ...
                           newUserRef.set(user);
                           UserData Client=new UserData(FirebaseAuth.getInstance().getUid(),email,TYPE_Account);
                            UserData.Insert_User(Client);
                            redirectLoginScreen();
    ...
    private void redirectLoginScreen(){
        ...
        Intent intent = new Intent(Main_RegisterClient.this, LoginActivity.class);
