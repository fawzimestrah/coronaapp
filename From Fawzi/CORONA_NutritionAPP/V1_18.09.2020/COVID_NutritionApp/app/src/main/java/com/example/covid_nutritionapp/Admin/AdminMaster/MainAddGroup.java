...
public class MainAddGroup extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_add_group);
        ...
        Bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!isEmpty(Ename.getText().toString()) && !isEmpty(Edes.getText().toString())) {
                    ...
                    Intent intent = new Intent(MainAddGroup.this, Main_RegisterAdmin.class);
                    setResult(1,intent);
                    finish();
                }
