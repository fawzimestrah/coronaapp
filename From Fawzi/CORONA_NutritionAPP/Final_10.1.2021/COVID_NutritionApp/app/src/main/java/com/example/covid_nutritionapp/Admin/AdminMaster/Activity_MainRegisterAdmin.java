...
public class Activity_MainRegisterAdmin extends AppCompatActivity {
    ...
    private DI_Adapter_CheckboxAdmin mArrayAdapter;

    @SuppressLint("ResourceAsColor")
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register_admin_layout);
        ...
        AddGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Activity_MainRegisterAdmin.this, Activity_AddGroupAdmin.class);
        ...
        mArrayAdapter = new DI_Adapter_CheckboxAdmin(getApplicationContext(), R.layout.cust_adapt_checkbox,ListGroupAdmin);
