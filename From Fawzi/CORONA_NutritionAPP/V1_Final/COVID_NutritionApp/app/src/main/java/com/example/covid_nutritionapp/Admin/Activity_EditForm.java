                    ...
                    myRefDetails.child(keyForm).child("QUESTIONS").child(D.getName_group()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                if(Dq.isShared()) {
                                    listQuest.add(Dq);
                                    //   Toast.makeText(getApplicationContext(),"dq="+Dq.getKey_value()+"///"+Dq.getGroup()+"///"+Dq.getQuestion(),Toast.LENGTH_LONG).show();
        ...
        Bedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkField()) {
                    ...
                    showDialog();
                    Data_forms.Update_form(Activity_EditForm.this,currentForm.getKey_value(), Ename.getText().toString(), currentForm.getDateform(), Edesc.getText().toString(), currentForm.getDescformLang(),user.getUid(), KeyGroup, listQuest);
                 //   hideDialog();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if(listQuest.size()>0){
                    if(nbQuestSaved>c){
                        ...
                        Data_Question.deleteQuestion(listQuest.get(c));
                    }
                    listQuest.remove(c); //
...
*/
    ...
    private boolean checkField(){
        if( isEmpty(Ename.getText().toString()) || isEmpty(Edesc.getText().toString()) || isEmpty(EGroup.getText().toString()) ){
